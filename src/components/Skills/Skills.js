                ...
                <Fade>
                    <div className="skills__container container">
                            <div className="icon-head-container">
                                <i className="icon-head lnr lnr-laptop-phone"></i>
                            </div>
                        <div className="skills__box content">
                            ...
                            <div className="skills__icon-container">
                                <div className="skills__icon-box">
                                    ...
                                    <span className="skills__icon-title">
                                        HTML
                                    </span>
                                </div>
                                <div className="skills__icon-box">
                                ...
                                <div className="skills__icon-box">
                                    <i className="skills__icon fab fa-js-square"></i>
                                    <span className="skills__icon-title">
                                        JavaScript
                                    </span>
                                </div>
                        ...
                        <div className="skills__box content">
                            ...
                            <div className="skills__icon-container">
                                ...
                                <div className="skills__icon-box">
                                    <i className="skills__icon fab fa-envira"></i>
                                    <span className="skills__icon-title">
                                        MongoDB
                                    </span>
                                </div>
                                <div className="skills__icon-box">
                                    <i className="skills__icon fas fa-layer-group"></i>
                                    <span className="skills__icon-title">
                                        Stack MERN
                                    </span>
                                </div>
                        ...
                        <div className="skills__box content">
                            ...
                            <div className="skills__icon-container">
                                <div className="skills__icon-box">
                                    <i className="skills__icon fab fa-git-alt"></i>
                                    <span className="skills__icon-title">
                                        Git
                                    </span>
                                </div>
                        ...
                        <div className="skills__box content">
                            ...
                            <div className="skills__icon-container">
                                <div className="skills__icon-box">
                                    <i className="skills__icon fab fa-angular"></i>
                                    <span className="skills__icon-title">
                                        Angular
                                    </span>
                                </div>
                                <div className="skills__icon-box">
                                    <svg className="skills__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                                ...
                                <div className="skills__icon-box">
                                    <i className="skills__icon fas fa-users"></i>
                                    <span className="skills__icon-title">
                                        Scrum
                                    </span>
                                </div>
